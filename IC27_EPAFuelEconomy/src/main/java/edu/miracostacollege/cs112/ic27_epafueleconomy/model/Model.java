...
public class Model {
	 ...
	 */
	public static boolean writeDataToBinaryFile(ObservableList<Vehicle> allVehicles)
	{
		// TODO: Create a File reference to the binary file
		...
		try {
			...
			Vehicle[] tempArray = new Vehicle[allVehicles.size()];
			allVehicles.toArray(tempArray);
